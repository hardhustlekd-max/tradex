...
export const OrderBook: React.FC<OrderBookProps> = ({
  ...
  return (
    <div className="w-full lg:w-60 bg-[#0d1117] border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col shrink-0 text-xs font-sans tabular-nums select-none h-full min-h-[250px] lg:min-h-0">
      ...
      <div className="h-9 px-2.5 bg-[#181a20] border-b border-white/10 flex items-center justify-between text-zinc-400 shrink-0 font-sans">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-1 rounded cursor-pointer transition-colors ${viewMode === 'both' ? 'bg-white/10 text-zinc-100' : 'hover:text-zinc-200'}`}
          ...
          <button
            ...
            className={`p-1 rounded cursor-pointer transition-colors ${viewMode === 'asks' ? 'bg-white/10 text-zinc-100' : 'hover:text-zinc-200'}`}
          ...
          <button
            ...
            className={`p-1 rounded cursor-pointer transition-colors ${viewMode === 'bids' ? 'bg-white/10 text-zinc-100' : 'hover:text-zinc-200'}`}
          ...
          {visibleAsks.map((ask, idx) => {
            ...
            return (
              ...
              >
                ...
                <span className="relative z-10 text-[#f6465d] font-semibold tracking-tight">
          ...
          {visibleBids.map((bid, idx) => {
            ...
            return (
              ...
              >
                ...
                <span className="relative z-10 text-[#00c076] font-semibold tracking-tight">
